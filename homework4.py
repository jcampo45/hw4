...
if __name__ == "__main__":
    ...
    f.write('Evaluating Models...\n')
    f.write('cn0\n')
    f.write(str(cn0.evaluate(xv, yv)))
    f.write('\ncn1\n')
    f.write(str(cn1.evaluate(xv, yv)))
    f.write('\ncn2\n')
    f.write(str(cn2.evaluate(xv, yv)))
    f.write('\ncn3\n')
    f.write(str(cn3.evaluate(xv, yv)))
    f.write('\nbn0\n')
    f.write(str(bn0.evaluate(xbinv, ybinv)))
    f.write('\nbn1\n')
    f.write(str(bn1.evaluate(xbinv, ybinv)))
    f.write('\nbn2\n')
    f.write(str(bn2.evaluate(xbinv, ybinv)))
    f.write('\nbn3\n')
    f.write(str(bn3.evaluate(xbinv, ybinv)))
    f.write('\nDone\n')
    f.close()
